    ...
    <footer className="bg-gray-900 text-white py-16">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-xl font-bold">RossCool</span>
            </div>
            <p className="text-gray-400 mb-6 leading-relaxed">
              Professional appliance repair services you can trust. 
              We fix what matters most to you.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li><a href="#" className="hover:text-white transition-colors">Refrigerator Service</a></li>
              ...
              <li><a href="#" className="hover:text-white transition-colors">Television Repair</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-400">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span>123 Main St, Downtown<br />City Center, State 12345</span>
              </div>
              <div className="flex items-center space-x-3">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; 2025 RossCool. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
